...
export const adminCreateCourse = async ({ data }: { data: any }) => {
  return fetchWithAuth("/courses", {
    method: "POST",
...
export const adminUpdateCourse = async ({ data }: { data: any & { id: string } }) => {
  const { id, ...rest } = data;
  return fetchWithAuth(`/courses/${id}`, {
    method: "PUT",
...
export const adminCreateInternship = async ({ data }: { data: any }) => {
  return fetchWithAuth("/internships", {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const adminUpdateInternship = async ({ data }: { data: any & { id: string } }) => {
  const { id, ...rest } = data;
  return fetchWithAuth(`/internships/${id}`, {
    method: "PUT",
    body: JSON.stringify(rest),
...
export const adminCreateTraining = async ({ data }: { data: any }) => {
  return fetchWithAuth("/trainings", {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const adminUpdateTraining = async ({ data }: { data: { id: string; [key: string]: any } }) => {
  const { id, ...rest } = data;
  return fetchWithAuth(`/trainings/${id}`, {
    method: "PUT",
    body: JSON.stringify(rest),
...
export const adminCreateCareer = async ({ data }: { data: any }) => {
  return fetchWithAuth("/careers", {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const adminUpdateCareer = async ({ data }: { data: { id: string; [key: string]: any } }) => {
  const { id, ...rest } = data;
  return fetchWithAuth(`/careers/${id}`, {
    method: "PUT",
    body: JSON.stringify(rest),
...
export const adminCreateProduct = async ({ data }: { data: any }) => {
  return fetchWithAuth("/products", {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const adminUpdateProduct = async ({ data }: { data: { id: string; [key: string]: any } }) => {
  const { id, ...rest } = data;
