  ...
  head: () => ({
    meta: [
      ...
      { title: "Enginow — Learn. Build. Belong." },
      {
        name: "description",
        content:
          "Enginow is a modern learning house for engineers — premium courses, training, internships, and career pathways designed for makers.",
      },
      { property: "og:title", content: "Enginow — Learn. Build. Belong." },
      {
        property: "og:description",
        content:
          "Premium courses, training, internships and career pathways for engineers.",
      },
...
function useAuth(): AuthState {
  ...
  useEffect(() => {
    // Firebase onAuthStateChanged fires immediately with the cached user (if any)
