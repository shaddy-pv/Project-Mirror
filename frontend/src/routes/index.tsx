...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Enginow — Learn engineering, deeply." },
      {
        name: "description",
        content:
          "A modern learning platform for engineers. Courses, cohort training, internships and careers — taught by people who ship.",
      },
      { property: "og:title", content: "Enginow — Learn engineering, deeply." },
      { property: "og:description", content: "Courses, training, internships and careers for engineers who build." },
    ...
    <section className="relative overflow-hidden" style={{ minHeight: "90vh" }}>
      ...
      <div className="relative z-10 mx-auto grid max-w-[1440px] grid-cols-12 gap-6 px-6 pt-10 pb-24 md:px-10 md:pt-16 md:pb-32">
        ...
        <div className="col-span-12 mt-10 md:col-span-7 md:mt-14">
          {latestCohort && (
            <Link to="/trainings/$slug" params={{ slug: latestCohort.slug || latestCohort.id }}>
              <motion.div
    ...
    <section className="mx-auto max-w-[1440px] px-6 py-24 md:px-10 md:py-28">
      ...
      <ul className="mt-4 divide-y" style={{ ["--tw-divide-opacity" as any]: 1 }}>
        {courses.map((c: any, i: number) => (
          <Link to="/courses/$slug" params={{ slug: c.slug || c.id }} key={c.id || i} className="block group transition-all"
            style={{
