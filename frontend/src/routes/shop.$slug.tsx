...
export const Route = createFileRoute("/shop/$slug")({
  ...
  loader: ({ params, context }) =>
    (context as any).queryClient.ensureQueryData(productQueryOptions(params.slug)),
  ...
  return (
    <main className="relative min-h-screen" style={{ background: "#FFFFFF" }}>
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-24 md:px-10">
        <Link to="/shop" className="inline-flex items-center gap-1.5 text-[13px] text-ink-mute hover:text-ink mb-8">
