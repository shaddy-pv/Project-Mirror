...
function CourseDetailPage() {
  ...
  async function handleEnroll() {
    ...
    try {
      ...
      if (!course.isFree && course.price > 0) {
        ...
        await new Promise<void>((resolve, reject) => {
          const rzp = new window.Razorpay({
            key: import.meta.env.VITE_RAZORPAY_KEY_ID, amount: amountToPay * 100, currency: "INR",
      ...
      navigate({ to: `/learn/${course.slug}` as any });
    } catch (err: any) {
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_340px]">
            ...
            <aside className="h-fit glass-shell">
              <div className="glass-card" style={{ borderRadius: "23px" }}>
                ...
                {isEnrolled && (
                  <Link to="/learn/$slug" params={{ slug: course.slug }} className="btn-amber mt-6 w-full justify-center">
