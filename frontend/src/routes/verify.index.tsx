...
export const Route = createFileRoute("/verify/")({
  ...
  head: () => ({
    meta: [
      { title: "Verify Certificate — Enginow" },
      { name: "description", content: "Verify the authenticity of an Enginow certificate or document." },
    ],
  }),
});
...
function VerifyIndexPage() {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    navigate({ to: "/verify/$certificateId", params: { certificateId: certId.trim() } });
  };
