...
import { adminCreateTraining } from "@/lib/admin.functions";

export const Route = createFileRoute("/_admin/admin-dashboard/trainings/new")({
  ...
  return (
    <div className="px-8 py-10">
      ...
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Create Training</h1>
          <p className="mt-1 text-[13.5px] text-ink-soft">Design a comprehensive training program.</p>
        </div>
      </div>
