...
export const Route = createFileRoute("/courses/")({
  ...
  head: () => ({
    meta: [
      { title: "Courses — Enginow" },
      { name: "description", content: "Browse premium engineering courses, cohorts and pathways on Enginow." },
      { property: "og:title", content: "Courses — Enginow" },
      { property: "og:description", content: "Browse premium engineering courses, cohorts and pathways on Enginow." },
