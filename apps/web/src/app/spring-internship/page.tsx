      ...
      <section className="relative px-6 pb-20 pt-24 md:px-10">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-6 text-5xl font-black tracking-tight text-[#1a1a1a] md:text-7xl">
            Spring <span className="text-amber-600">Internship</span>.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-600">
            We have a spring internship program for various durations for which users can apply during the designated time, and if shortlisted they will get all the benefits of that.
          </p>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2 rounded-2xl bg-white px-5 py-3 shadow-sm ring-1 ring-black/5">
              ...
              <div className="text-left">
                ...
                <p className="font-semibold text-gray-900">February first week</p>
              </div>
            </div>
          </div>
          <div className="mt-12">
            <Link href="/internship?type=spring" className="inline-flex items-center justify-center gap-2 rounded-full bg-amber-600 px-8 py-3.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-amber-700 hover:shadow-md hover:ring-2 hover:ring-amber-600 hover:ring-offset-2">
