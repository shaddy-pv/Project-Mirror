...
import {
  ...
  Star, ExternalLink, ChevronRight, Loader2, Search,
} from "lucide-react";
...
import {
  ...
  issueCertificate, getIssuedCertificates,
  type Application,
} from "@/mocks/api";
        ...
        <div className="mt-6 space-y-5 px-1 pb-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {(["pending", "shortlisted", "oa", "selected", "rejected"] as const).map(s => (
...
function ApplicationsTab() {
  ...
  const handleStatusChange = async (id: string, status: string) => {
    await updateInternshipApplicationStatus(id, status);
    ...
    <div>
      <div className="mt-4 flex flex-wrap items-center gap-2">
        ...
        <div className="flex flex-wrap gap-1.5">
          {["all", "pending", "shortlisted", "oa", "selected", "rejected"].map((s) => (
